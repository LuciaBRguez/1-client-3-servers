class UI {
    ...
    postCreativeWork(){
        ...
        $.ajax({
            method:'POST',
            data:contentPost,
            url:"http://156.35.95.76:8000:8000/phpServer.php/creativeWork",
    ...
    getCreativeWork() {
        $.ajax({
            ...
            method:'GET',
            url:"http://156.35.95.76:8000/phpServer.php/creativeWork",
    ...
    deleteCreativeWork() {
        ...
        $.ajax({
            ...
            method:'DELETE',
            url:"http://156.35.95.76:8000/phpServer.php/creativeWork/"+id,
